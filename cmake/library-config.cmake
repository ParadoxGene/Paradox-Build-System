...
function(paradox_c_library lib_name lib_prefix)
    get_property(${lib_prefix}_C_LIB_EXISTS GLOBAL PROPERTY ${lib_prefix}_C_LIB_EXISTS_PROPERTY)
    if(NOT ${lib_prefix}_C_LIB_EXISTS AND PARADOX_LANGUAGE STREQUAL "c")
        set_property(GLOBAL PROPERTY ${lib_prefix}_C_LIB_EXISTS_PROPERTY ON)
...
function(paradox_cxx_library lib_name lib_prefix)
    get_property(${lib_prefix}_CXX_LIB_EXISTS GLOBAL PROPERTY ${lib_prefix}_CXX_LIB_EXISTS_PROPERTY)
    if(NOT ${lib_prefix}_CXX_LIB_EXISTS AND PARADOX_LANGUAGE STREQUAL "cpp")
        set_property(GLOBAL PROPERTY ${lib_prefix}_CXX_LIB_EXISTS_PROPERTY ON)
        file(GLOB_RECURSE ${lib_prefix}_CXX_SRC "${PROJECT_DIR}/api/cpp/${lib_name}/src/**.cpp")
        ...
        target_include_directories(${lib_name} PUBLIC "${PROJECT_DIR}/api/cpp/${lib_name}/include/")
    endif()
endfunction()
...
function(paradox_add_tests lib_name lib_prefix link_libs)
    ...
    if(${lib_prefix}_BUILD_TESTS AND PARADOX_LANGUAGE STREQUAL "c")
        get_property(${lib_prefix}_C_TESTS_EXISTS GLOBAL PROPERTY ${lib_prefix}_C_TESTS_EXISTS_PROPERTY)
        if(NOT ${lib_prefix}_C_TESTS_EXISTS)
            set_property(GLOBAL PROPERTY ${lib_prefix}_C_TESTS_EXISTS_PROPERTY ON)
    ...
    if(${lib_prefix}_BUILD_TESTS AND PARADOX_LANGUAGE STREQUAL "cpp")
        get_property(${lib_prefix}_CXX_TESTS_EXISTS GLOBAL PROPERTY ${lib_prefix}_CXX_TESTS_EXISTS_PROPERTY)
        if(NOT ${lib_prefix}_CXX_TESTS_EXISTS)
            set_property(GLOBAL PROPERTY ${lib_prefix}_CXX_TESTS_EXISTS_PROPERTY ON)
